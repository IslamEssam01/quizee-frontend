...
import { quizQueryOptions, useQuiz, type QuestionType } from "@/hooks/useQuiz";
...
function RouteComponent() {
    ...
    const isDisabled = updateQuizMutation.isPending;
    ...
    function setQuestionType(key: string, type: QuestionType) {
        updateQuestion(key, (question) => ({
            ...
            options:
                type === "T OR F"
                    ? [
                          { key: crypto.randomUUID(), text: "True", is_correct: false },
                          { key: crypto.randomUUID(), text: "False", is_correct: false },
                      ]
                    : blankOptions(4),
        }));
    }
